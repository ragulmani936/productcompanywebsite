...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="footer">
        Copyright &#169; 2021 EduSoft Private Limited, Developed by Ragul.
      </div>
    </div>
  </body>
</html>
        ...
        <div class="productcontent">    
          ...
          <div class="productitems">
              ...
              <div class="productitem"> 
                ...
                <div class="itemname">Trophy</div>
                <div class="itemprice">Price: &#8377; 75,000.00 </div>
              </div>
              <div class="productitem"> 
                <div class="itemimage">
                <img src="/static/imp/12.jpg"  alt="UPS">
                </div>
                <div class="itemname">SS bat</div>
                <div class="itemprice">Price: &#8377; 10,000.00 </div>
              </div>
...
.banner {
  ...
  Georgia, serif;
  font-size: 60px;
  background-image: url("/static/imp/bg.jpeg");
...
![output](https://github.com/ragulmani936/productcompanywebsite/blob/main/Screenshot%20(43).png?raw=true)
### Product Page:

![output](https://github.com/ragulmani936/productcompanywebsite/blob/main/Screenshot%20(44).png?raw=true)
### People Page:

![output](https://github.com/ragulmani936/productcompanywebsite/blob/main/Screenshot%20(45).png?raw=true)
### Contact Page:

![output](https://github.com/ragulmani936/productcompanywebsite/blob/main/Screenshot%20(46).png?raw=true)
## Result:
